...
window.addEventListener('scroll', function (e) {
  ...
  for (var _i = 1; _i < sections.length; _i++) {
    if (sections[_i].offsetTop + 150 <= scrollY + clientHeight && !sections[_i].isActive) {
      sections[_i].isActive = true;

      sections[_i].classList.add('animated');
    }
  }
});

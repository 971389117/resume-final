...
(function () {
  ...
  var model = {
    ...
    save: function save(name, content) {
      // 声明类型
      var Message = AV.Object.extend('Message'); // 新建对象
  ...
  var view = document.querySelector('#comments');
  var controller = {
    view: null,
    model: null,
    messageList: null,
    ...
    saveMessage: function saveMessage() {
      ...
      this.model.save(name, content).then(function (obj) {
        var li = createLi(obj.attributes);
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/message.js"], null)
//# sourceMappingURL=/message.baa57d69.map